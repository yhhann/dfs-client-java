...
public class RandomStringUtils {
   ...
   * {@link #random(int,int,int,boolean,boolean,char[],Random)}, but instead of using an externally
   ...
   *
   * <p>
   * If start and end are both {@code 0}, start and end are set to {@code ' '} and {@code 'z'}, the
   * ASCII printable characters, will be used, unless letters and numbers are both {@code false}, in
   * which case, start and end are set to {@code 0} and {@code Integer.MAX_VALUE}.
   *
   * <p>
